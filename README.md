...
- 🚩 [Cardinal](https://github.com/vidar-team/Cardinal) - CTF AWD platform / [★517](https://github.com/vidar-team/Cardinal/stargazers) / `Go` `GORM` `Vue` `Server-Sent Events` `CRUD`
...
- 💫 [Asteroid](https://github.com/wuhan005/Asteroid) - CTF AWD real-time 3D data visualization / [★96](https://github.com/wuhan005/Asteroid/stargazers) / `C#` `Unity3D` `WebSocket`
