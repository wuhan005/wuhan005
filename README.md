...
- 📫 [NekoBox](https://github.com/wuhan005/NekoBox) - Anonymous question box / [★290](https://github.com/wuhan005/NekoBox/stargazers) / `Go` `GORM` `Flamego` `Uptrace` `CRUD` `reCaptcha`
...
- 🚩 [Cardinal](https://github.com/05sec/Cardinal) - [Archive] CTF AWD platform / [★988](https://github.com/05sec/Cardinal/stargazers) / `Go` `GORM` `Vue` `Server-Sent Events` `CRUD`
...
- 💫 [Asteroid](https://github.com/wuhan005/Asteroid) - [Archive] CTF AWD real-time 3D data visualization / [★141](https://github.com/wuhan005/Asteroid/stargazers) / `C#` `Unity3D` `WebSocket`
