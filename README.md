...
- 🚩 [Cardinal](https://github.com/vidar-team/Cardinal) - CTF AWD platform / [★535](https://github.com/vidar-team/Cardinal/stargazers) / `Go` `GORM` `Vue` `Server-Sent Events` `CRUD`
...
- 🔮 [Elaina](https://github.com/wuhan005/Elaina) - Docker-based remote code runner / [★29](https://github.com/wuhan005/Elaina/stargazers) / `Go` `Vue` `Docker` `Rate Limit` `CodeMirror`
