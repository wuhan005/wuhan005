...
- 🚩 [Cardinal](https://github.com/vidar-team/Cardinal) - CTF AWD platform / [★841](https://github.com/vidar-team/Cardinal/stargazers) / `Go` `GORM` `Vue` `Server-Sent Events` `CRUD`
